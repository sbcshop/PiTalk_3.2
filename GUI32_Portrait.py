...
class MainApp(pitalk.PiTalk, tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.w = 240  #screen width
        self.h = 320  #screen height
        ...
        self.timeLabelTop = tk.Label(self.Topframe,font=("Helvetica", 10),
                                     text = "",bg = "black", fg = "tomato")
        self.timeLabelTop.place(x=90, y=0)

        self.callLabelTop = tk.Label(self.Topframe,bg = "black")
        self.callLabelTop.place(x=150, y=0)
            
        self.msgLabelTop = tk.Label(self.Topframe, bg = "black")
        self.msgLabelTop.place(x=180, y = 0)

        self.signal = tk.Canvas(self.Topframe, width=self.bar_width,bg= "black",
                                height=self.bar_height,highlightthickness=0,
                                bd=0)
        self.signal.grid(row = 0, column = 7, sticky = "e")

        container = tk.Frame(self,height=320, width=240, bg = "black")
        ...
        for F in (HomeFrame,Menu1Frame,Menu2Frame,CallFrame,CallIncomingFrame,
                  CamFrame,MessageFrame,InboxBodyFrame,InboxFrame,CreateSMSFrame,
                  DeleteSMSFrame,StopwatchFrame,SettingsFrame,GUIRotateFrame,
                  CallSettingFrame,CalendarFrame,AudioFrame,AboutFrame,
                  SIMFrame,GalleryFrame,CalculatorFrame,SensorFrame,PiFrame,
                  InternetFrame,ShutdownFrame,HDMIFrame,LogFrame,LocationFrame,
                  TemplateFrame):
...
class HomeFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.canvas = tk.Canvas(self,bg="black",width = 240,height = 240,
                                highlightthickness=0,bd=0)
        self.circle = self.canvas.create_oval(35,35,205,205,outline="tomato",
                                              width=7)     
        ...
        self.dateLabel = tk.Text(self,bg = "black", fg = "yellow" ,height = 8,
                                 width = 16, bd  = 0, highlightthickness = 0)
        self.dateLabel.grid(row = 1, column = 1, padx = (7,0), pady = (13,0))

        self.call = tk.Button(self, text = "Call", image=icons[4],
                              font=("helvetica", 11),bg = "black", fg = "white",
                              bd = 0,highlightbackground="black",compound="top",
                              activebackground="black",activeforeground="white",
                              command=lambda: controller.show_frame("CallFrame"))
        self.call.grid(row = 3, column = 0, pady=(0,5))

        self.menu = tk.Button(self, image=icons[22],font=("helvetica", 11),
                              text="Menu",bg="black",fg="white",bd = 0,
        ...
        self.camera = tk.Button(self,image=icons[8],font=("helvetica",11),
                                text="Camera",bg="black",fg="white",bd=0,
                                highlightbackground="black",compound="top",
                                activebackground="black",activeforeground="white",
                                command=lambda:controller.show_frame("CamFrame"))
    ...
    def update_Clock(self):
        ...
        self.dateLabel.tag_config("time",foreground="tomato",
                                  font=("Helvetica",15),
                                  background="black",justify="center")
...
class Menu1Frame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        for b in range(len(BUTTON)):
            ...
            tk.Button(self,text=BUTTON[b][0],bg="white",font=("helvetica", 11),
                      fg="black",bd=0,highlightbackground="white",
                      compound='top',
                      activebackground="white",activeforeground="black",
                      image=BUTTON[b][1],command=cmd).grid(row=BUTTON[b][3],
                                                           column=BUTTON[b][4],
                                                           sticky ="nsew",
                                                           ipadx=0,ipady = 0) 
...
class Menu2Frame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        for b in range(len(BUTTON)):
            cmd = lambda x=BUTTON[b][2]: controller.show_frame(x)
            tk.Button(self,text=BUTTON[b][0],bg="white",font=("helvetica",11),
                      fg="black",highlightbackground="white",compound='top',bd=0,
                      activebackground="white",activeforeground="black",
                      image=BUTTON[b][1],command=cmd).grid(row=BUTTON[b][3],
                                                           column=BUTTON[b][4],
                                                           sticky="nsew",
    ...
    def outgoing_Call(self):
        ...
        if len(self.diallednumber.get()):
            ...
            self.outgoingcall=tk.Label(self,text="Outgoing Call",
                                       font=("bold",18),fg="tomato",bg="white")
            ...
            self.hangup.grid(row=3,column=0,pady=(0,10))
            ...
            self.headfone.grid(row=3,column=1,pady=(0,10))
            ...
            self.speaker.grid(row=3,column=2,pady=(0,10))
...
class CallIncomingFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.incominglabel=tk.Label(self,text="Incoming Call",font=("bold",18),
                                    fg="gold3",bg="black")
        self.incominglabel.grid(row=0,column=0,columnspan=5)

        self.number=tk.Label(self,text="",font=("bold", 15),fg="red4",
                             bg="black")
        self.number.grid(row=1,column=0,columnspan=5)

        self.timer=tk.Label(self,text="00:00:00",font=("Bold",12),bg="black",
                            fg="white")
        self.timer.grid(row=2,column=0,columnspan=5)

        self.hangup=tk.Button(self,image=icons[6],bg="black",fg="black",bd=0,
                              highlightbackground="black",
                              activebackground="black",
                              command=self.call_hangup)
        self.hangup.grid(row=4,column=0)

        self.headfone=tk.Button(self,image=icons[15],bd=0,bg="black",fg="black",
                                highlightbackground="black",
                                activebackground="black",
        ...
        self.speaker=tk.Button(self,image=icons[34],bd=0,bg="black",fg="black",
                               highlightbackground="black",
        ...
        self.connect.grid(row=4,column=4)

        self.label=tk.Label(self,text="",font=("bold",12),fg="black",bg="black")
    ...
    def call_time_counter(self):
        ...
        if(self.Fl_incoming_call_start):
            ...
            if self.second == 59:
                self.minute=self.minute+1 ; self.second = -1
            elif self.minute == 59:
                self.hour = self.hour + 1; self.minute = -1
...
class InboxFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.vsb = tk.Scrollbar(self,orient="vertical",command=canvas.yview,
                                width=15)
        canvas.configure(yscrollcommand=self.vsb.set)

        self.vsb.pack(side="right",fill="y")
        canvas.pack(side="left",fill="both",expand=True)
        canvas.create_window((0,0),window=self.frame,width=240,anchor="nw")
...
class InboxBodyFrame(tk.Frame):
    ...
    def open_sms(self, args):
        ...
        self.datetime=tk.Label(self,text=self.controller.messageData[args][1],
                               font=("Helvetica",10),bg="black",fg="tomato")
        self.datetime.grid(row=1,column=0,columnspan=3,sticky="nsew")
        
        self.bodySMS=tk.Text(self,bg="white",fg="black",height=10,width=40)
        self.bodySMS.delete(1.0, "end")
        self.bodySMS.insert(1.0, self.controller.messageData[args][2])
        self.bodySMS.grid(row=2,column=0,columnspan=3,padx=10,sticky="nsew")

        self.reply=tk.Button(self,text="Reply",bg="white",bd =0,
                             highlightbackground="white",activeforeground="black",
                             activebackground="white",command=lambda args=args:
                             self.reply_msg(args))
...
class CreateSMSFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.messageBody=tk.Text(self,height=10,width=35)
        ...
        for k in range(30):
            ...
            self.buttonCharData[k]=tk.Button(self,text=self.specialChar[k],
                                             command=lambda k=k:
                                             self.messageEntry(self.specialChar\
                                                               [k]))
            self.buttonCapsData[k]=tk.Button(self,text=self.letterCaps[k],
                                             command=lambda k=k:
                                             self.messageEntry(self.letterCaps[k]))
        ...
        delete=tk.Button(self,text="DEL",command=self.single_Char_Delete)
...
class DeleteSMSFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.warningLabel = tk.Label(self,bg="black",fg="Deep sky blue",
                                     font=("Helvetica",12),text="Selecting this "
                                     "deletes messages \nfrom your GSM Module"
                                     "only")
        self.warningLabel.grid(row=0,column=0,columnspan=3)
        tk.Label(self,text="Press OK to confirm",font=("Helvetica",12),fg="yellow",
                 bg="black").grid(row=1,column=1)
        
        ok=tk.Button(self,text="OK",fg="yellow",image=icons[21],anchor="center",
    ...
    def deletesms(self):
        ...
        phone.deleteSMS()
        self.controller.msgLabelTop.configure(image = "")
        label=tk.Label(self,text=" SIM messages Deleted",fg="black",bg="yellow")
        ...
        if(response == b'supported=1 detected=1\n'):
            ...
            while(self.exitFlag):
                if self.captureFlag == True:
                    camera.capture(path+'/Gallery/Photos/'+'img_'+\
...
class InternetFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        Label=tk.Label(self,text="APN",font=("bold",12),bg="black",fg="yellow")
        Label.grid(row = 0, column = 0, columnspan = 2, sticky="e")

        self.APN = tk.Entry(self, width = 10, font=("bold", 13))
        self.APN.grid(row = 0, column = 2, columnspan = 4)
        self.APN.bind("<FocusIn>", self.remember_Focus)
        self.APN.focus()

        Label=tk.Label(self,text="PORT",bg="black",font=("bold",12),fg="yellow")
        Label.grid(row=1,column=0,columnspan=2,pady=(10,30),sticky="e")

        self.Port=tk.Entry(self,width=15,font=("bold",13))
        self.Port.grid(row=1,column=2,columnspan=4,pady=(10,30))
        self.Port.bind("<FocusIn>",self.remember_Focus)
        self.Port.focus()

        self.connect=tk.Button(self,text="Connect",fg="green",command=self.connect)
        self.connect.place(x=150,y=7)
        self.disconnect=tk.Button(self,text="Disconnect",fg="red",
                                  command=self.disconnect)
        self.disconnect.place(x=150,y=50)
        self.status=tk.Button(self,text="Check Status",
                              command=self.check_status)
        self.status.place(x=130,y=90)
        ...
        for k in range(30):
            ...
            self.buttonCharData[k]=tk.Button(self,font=1,text=self.specialChar[k],
                                             command=lambda k=k:
                                             self.messageEntry(self.specialChar[k]))
        ...
        home=tk.Button(self,text="HOME",fg="red4",
                       command=lambda:controller.show_frame("HomeFrame"))
        ...
        space=tk.Button(self,text="space",bg="gray60"
...
class GalleryFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.photo = tk.Button(self,text="Photos",bg="white",fg="black",bd=0,
                               highlightbackground="white",
                               activebackground="white",activeforeground="black",
                               image=icons[9],compound="top",
        ...
        self.next.place(x=150, y=270)

        self.label=tk.Label(self,text= "",bg="white",fg="black")
        self.label.place(x=190, y=275)
    ...
    def view_images(self):
        ...
        for file in sorted(os.listdir(path+'/Gallery/Photos')):
            ...
            img = img.resize((240, 260), Image.ANTIALIAS)
...
class CalculatorFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.square=tk.Button(self,text="x²",font=("bold",11),width=3,bg="black"
                              ,fg="white",command=self.square)
        self.square.grid(row=1,column=0,sticky="nsew")

        self.sqroot=tk.Button(self,text="√",font=("bold",11),width=3,bg="black",
                              fg="white",command=self.squareroot)
        self.sqroot.grid(row=1,column=1,sticky="nsew")

        self.AC=tk.Button(self,text="AC",font=("bold",11),width=3,bg="black",
                          fg="white",command=self.deleteall)
        self.AC.grid(row=1,column=2,sticky="nsew")

        self.C=tk.Button(self,text="C",font=("bold",11),width=3,bg="black",
                         fg="white",command=self.delete1)
        ...
        for k in range(16):
            ...
            self.calculatorKeyData[k]=tk.Button(self,text=self.calculatorKeys[k],
                                                font=("bold",11),width=3,
                                                bg="black",fg="white",
                                                command=lambda k=k:
                                                self.entryaction(self.calculatorKeys[k]))
        ...
        tk.Button(self,text="=",bg="black",fg="white",font=("bold",14),
                  command=self.equals).grid(row=6,column=2,columnspan=2,
                                            sticky="nsew")

        tk.Button(self,bg="black",fg ="red",text="Back",font=("bold",11),
                  command=self.back).grid(row=6,column=0,sticky="nsew")
        
        tk.Button(self,bg="black",fg="Deep sky blue",text="Home",font=("bold",11),
...
class StopwatchFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.canvas = tk.Canvas(self,bg="black",width = 240, height = 200,
                                     highlightthickness=0,bd=0)
        self.canvas.create_oval(35,35,205,205,outline="royal blue",width=7)
        self.canvas.grid(row=0,column=0,rowspan=3,columnspan=3,sticky="nsew")

        tk.Label(self,text="HH : MM : SS",fg="white",bg="black",
                 font=("helvetica", 16)).place(x=55,y=80)
        
        self.stopwatch=tk.Label(self,bg="black",fg="yellow",font=("helvetica",15),
                                text="00:00:00",bd=0,highlightthickness=0)
        self.stopwatch.grid(row=1,column=1,sticky="s")
        ...
        goback = tk.Button(self,bg="black",fg="black",bd=0,
                           highlightbackground="black",
                           activebackground="black",
                           activeforeground="black",image=icons[30],
                           text="Home",command=self.back)
        goback.grid(row=4,column=0)
        gohome=tk.Button(self,bg="black",fg="black",bd=0,
                         highlightbackground="black",activebackground="black",
                         activeforeground="black",image=icons[16],text="Home",
                         command=self.home)
...
class CalendarFrame(tk.Frame):
    ...
    def setup(self, y, m):
        """ Setup """
        left_month=tk.Button(self,text='<',bg="black",fg="tomato",
                             command=self.go_prev_month)
        self.wid.append(left_month)
        left_month.grid(row=0,column=0)
        right_month=tk.Button(self,text='>',bg="black",fg="tomato",
        ...
        left_year=tk.Button(self,text='∨',bd=0,bg="black",fg="tomato",
                            command=self.go_prev_year)
        self.wid.append(left_year)
        left_year.grid(row=0, column=5)         
        right_year=tk.Button(self,text=' ∧',bd=0,bg="black",fg="tomato",
...
class AudioFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.speaker=tk.Button(self,text="Speaker \nMode",image=icons[34],
                               ...
                               highlightbackground="black",
                               activebackground="black",
                               activeforeground="white",compound="top",anchor="w",
                               command=self.speaker_mode)
        self.speaker.grid(row = 0, column = 2,sticky = "s")

        self.slider=tk.Scale(self,from_=0, to=7,orient="horizontal",bg="black",
                             fg="white",bd=0,highlightbackground="black",
                             state="disable")
...
class SensorFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self,text="Read ADC Values",font=("bold", 15),bg="black",
                 fg="red").grid(row=0,column=0,columnspan=5)
        
        tk.Label(self,text="Measure Voltage Range 0v - 2.1v",font=("bold",10),
                 bg="yellow").grid(row=1,column=0,sticky="n",columnspan = 5)

        tk.Label(self,text="ADC 0",bg="black",font=("bold",12),
                 fg="gold2").grid(row=2,column=0,sticky="n",
                                  columnspan=2)
        tk.Button(self,text="Read ADC 0\n (mV)",
                  command=self.read_ADC0).grid(row=3,column=0,sticky="n")
        
        self.adc0 = tk.Entry(self,width = 7, font = ("Helvetica", 15))
        self.adc0.grid(row = 3, column = 1)
        
        tk.Label(self,text="ADC 1",bg="black",font=("bold", 12),
                 fg="gold2").grid(row=4,column=0,sticky="n",columnspan=2)
        tk.Button(self,text="Read ADC 1\n (mV)",
                  command=self.read_ADC1).grid(row=5,column=0,sticky='n')
        
        self.adc1 = tk.Entry(self,  width = 7, font = ("Helvetica", 15))
        self.adc1.grid(row = 5, column = 1)

        tk.Button(self,bg="black",fg="black",bd=0,highlightbackground="black",
                  activebackground="black",activeforeground="black",
                  image=icons[30],command=self.back).grid(row = 6, column = 0)
        tk.Button(self,bg="black",fg="black",bd=0,highlightbackground="black",
                  activebackground="black",activeforeground="black",
                  image=icons[16],command =self.home).grid(row=6,column=1)
...
class PiFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.warningLabel=tk.Label(self,bg="black",fg="Deep sky blue",
                                   font=("helvetica",13),text="This feature "\
                                   "allows you to\n access your Raspberry Pi \n"\
                                   "by shutting down the phone UI")
        self.warningLabel.grid(row=0,column=0,columnspan=3,sticky="nsew")
        
        tk.Label(self,text="Press OK to confirm",font=("Helvetica",11),
                 fg="yellow",bg="black").grid(row=1,column=1)
        
        ok=tk.Button(self,text="OK",fg="yellow",image=icons[18],anchor="center",
                     highlightbackground="white",bg="black",
                     activebackground="black",activeforeground="white",
        ...
        back=tk.Button(self,text="Back",image=icons[30],bd=0,
                       ...
                       activebackground="black",anchor="center",command=lambda:
                       self.controller.show_frame("Menu2Frame"))
        back.grid(row = 3, column = 0)
...
class AboutFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        header_label=tk.Label(self,text="PiTalk",font=("Helvetica",12),
                              fg="gold2",bg="black")
        header_label.grid(row = 0, column = 2, sticky = "ew")

        tk.Label(self,text='PiTalk is a 3G GSM Shield for  RPi',bg="black",
                 fg="olive drab").grid(row=1,column=0,columnspan=5,sticky="w")
        tk.Label(self,text="  ->Quectel UC15 Chipset",bg="black",
                 fg="white").grid(row=2,column=0,sticky="w",columnspan=5)
        tk.Label(self,text='  ->Compatible with 3.2", 4", 5" LCD',bg="black",
                 fg="white").grid(row=3,column=0,sticky="w",columnspan=5)
        tk.Label(self,text="  ->Quad band UTMS/HSPDA Module",bg="black",
                 fg="white").grid(row=4,column=0,sticky="w",columnspan=5)
        tk.Label(self,text="  ->Compatiable with Pi2/Pi3/PiZero",bg="black",
                 fg="white").grid(row=5,column=0,sticky="w",columnspan=5)
        tk.Label(self,text="For More Info:",bg="black",
                 fg="turquoise").grid(row=6,column=0,sticky="w",columnspan=5)
        tk.Label(self,text='    www.sb-components.co.uk',bg="black",
                 fg="white").grid(row=7,column=0,sticky="w",columnspan=5)
        tk.Label(self,text="Developed by:",bg="black",
                 fg="tomato").grid(row=8,column=0,sticky="w",columnspan=5)
        tk.Label(self,text="  Ankur Singh ",bg="black",
                 fg="white").grid(row=9,column=0,sticky="w",columnspan=5)
        tk.Label(self,text="  Asher Ahmad Farooqui",bg="black",
                 fg="white").grid(row=10,column=0,sticky="w",columnspan=5)

        back_button=tk.Button(self,image=icons[30],bg="black",fg="black",bd=0,
                              highlightbackground="black",
                              activebackground="black",
                              activeforeground="black",
                              command=lambda:controller.show_frame("Menu2Frame"))
...
class SIMFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self,text="IMEI Number:",font=("Helvetica",14),bg="black",
                 fg="orange red").pack(pady=(10,0))

        self.imeiLabel=tk.Label(self,text="",font=("Helvetica",12),
                                bg="black",fg="yellow")
        self.imeiLabel.pack()

        tk.Label(self,text="Module: ",bg="black",font=("Helvetica",14),
                 fg="orange red").pack()

        tk.Label(self,text="Quectel UC15",font=("Helvetica",12),bg="black",
                 fg="yellow").pack()

        tk.Label(self,text="Carrier:",font=("Helvetica",14),bg="black",
                 fg="orange red").pack()

        self.networkLabel=tk.Label(self,text="",font=("Helvetica",12),bg="black",
                                   fg="yellow")
        self.networkLabel.pack()

        tk.Button(self,text="Read",bg="black",fg="tomato",
                  command=self.read).pack(pady=20)

        tk.Button(self,image=icons[30],bg="black",fg="black",bd=0,
                  highlightbackground="black",activebackground="black",
                  activeforeground="black",command=lambda:
                  controller.show_frame("Menu2Frame")).pack(side="left",padx=10)

        tk.Button(self,image=icons[16],bg="black",fg="black",bd=0,
                  highlightbackground="black",activebackground="black",
                  activeforeground="black",command=lambda:
                  controller.show_frame("HomeFrame")).pack(side="right",padx=10)
    ...
    def __init__(self, parent, controller):
        ...
        for b in range(len(BUTTON)):
            ...
            tk.Button(self,text=BUTTON[b][0],image=BUTTON[b][1],bg="black",
                      fg="white",anchor="w",bd=0,highlightbackground="black",
                      activeforeground="white",activebackground="black",
                      font=("helvetica",12),compound='left',
                      command=cmd).grid(row=b,column=0,sticky="nsew")
...
class GUIRotateFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label=tk.Label(self,text="This will reboot your system\nand "\
                       "calibrate the screen",font=("helvetica", 13),bd=2,
                       fg="tomato",bg="black")
        label.grid(row = 0, column = 0,columnspan = 2 , sticky = "nsew")
        
        rotate0=tk.Button(self,text="Rotate 0°  ",command=lambda:
                          self.screenRotate(0),bg="black",fg="white",bd=2,
                          highlightbackground="black",compound="top",
                          activebackground="black",activeforeground="white",
                          image=icons[39])
        rotate0.grid(row = 1, column = 0)

        rotate90=tk.Button(self,text="Rotate 90° ",command=lambda:
                           self.screenRotate(90),bg="black",fg="white",bd=2,
                           highlightbackground="black",compound="top",
                           activebackground="black",activeforeground="white",
                           image=icons[40])
        rotate90.grid(row = 1, column = 1)

        rotate180 = tk.Button(self,text="Rotate 180°",command=lambda:
                              self.screenRotate(180),bg="black",fg="white",bd=2,
                              highlightbackground="black",compound="top",
                              activebackground="black",activeforeground="white",
                              image=icons[41])
        rotate180.grid(row = 2, column = 0)

        rotate270=tk.Button(self,text="Rotate 270°",command=lambda:
                            self.screenRotate(270),bg="black",fg="white",bd=2,
                            highlightbackground="black",compound="top",
                            activebackground="black",activeforeground="white",
                            image=icons[42])
        ...
        home=tk.Button(self,text="Go Home",image=icons[16],bg="black",fg="white",
...
class CallSettingFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        canvas=tk.Canvas(self,bg="snow",height=10).grid(row=0,column=0,
                                                        columnspan=6,sticky="nsew")
        tk.Label(self,bg="snow",fg="black",font=("bold",10),
                 text="Auto Answering:").grid(row=0,column=0,columnspan=3)

        self.ringspin=tk.Spinbox(self,from_=0, to = 10,font=("bold",12),width=4)
        self.ringspin.grid(row=0,column=3,columnspan=2)
        tk.Button(self,text="Set",bg="deep sky blue",fg="white",
                  command=self.ring_Set).grid(row=0,column=5)

        tk.Label(self,bg="black",fg="yellow",font=("bold",11),
                 text="Forward :").grid(row=1,column=0,columnspan=2)

        self.forwardnumber=tk.Entry(self,justify="right",fg='RoyalBlue1',
                                    font=("bold",12))
        self.forwardnumber.grid(row=1,column=2,columnspan=4,sticky="ew")
        tk.Button(self,text="Enable",
                  command=self.set_callforwarding).grid(row=2,column=4,
                                                        columnspan=2)
       
        for b in range(12):
            cmd = lambda x=BUTTON[b][0]: self.dial_Entry(x)
            self.buttons.append(tk.Button(self,text=BUTTON[b][0],font=("bold",12),
                                          highlightbackground="black",
                                          activebackground = "black",
                                          activeforeground="white",
                                          bg="black",fg="white",bd=0,command=cmd))
            self.buttons[b].grid(row=BUTTON[b][2],column=BUTTON[b][3])

        tk.Button(self,text="Check",
                  command=self.check_status).grid(row=2,column=0,columnspan=2)

        tk.Button(self,text="Disable",
                  command = self.disable_callforwarding).grid(row=2,column=2,
                                                              columnspan=2)        
        
        tk.Button(self,image=icons[16],bg="black",fg="white",bd=0,
                  highlightbackground="black",activebackground="black",
                  activeforeground="black",command=self.home).grid(row=6,column=5)

        tk.Button(self,image=icons[30],bg="black",fg="black",bd=0,
                  highlightbackground="black",activebackground="black",
                  activeforeground="black",command=lambda:
                  controller.show_frame("SettingsFrame")).grid(row=6,column=0)
...
class HDMIFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.warningLabel=tk.Label(self,bg="black",fg="Deep sky blue",
                                   font=("helvetica", 14),text="Selecting this "\
                                   "reboots and \nchanges output to HDMI")
        self.warningLabel.grid(row=0,column=0,columnspan=3,sticky="nsew")
        tk.Label(self,text="Press OK to confirm",font=("helvetica",12),
                 fg="yellow",bg="black").grid(row = 1, column = 1)
        ...
        tk.Button(self,text="Go Home",image=icons[16],anchor="center",bd=0,
                  highlightbackground="black",bg="black",activebackground="black",
                  command=lambda:controller.show_frame("HomeFrame")).grid(row=3,
                                                                          column=2)
...
class LogFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.warningLabel=tk.Label(self,bg="black",fg="Deep sky blue",
                                   font=("helvetica", 14),text = "Enable/Disable"\
                                   " or \nDelete ALL logs")
        self.warningLabel.grid(row = 0, column = 0, columnspan = 3)
        
        self.enable=tk.Button(self,text="Enable Log",font=("helvetica", 10),
                                 command=self.enable_log,bg="black",fg="white",
                                 bd=0,highlightbackground="black",compound="top",
                                 activebackground="black",state="disable",
                                 activeforeground="white",image=icons[47])
        self.enable.grid(row = 1, column = 0)

        self.disable=tk.Button(self,text="Disable Log",font=("helvetica",10),
                                  command=self.disable_log,bg="black",fg="white",
                                  bd=0,highlightbackground="black",compound="top",
                                  activebackground="black",
                                  activeforeground="white",image=icons[48])
        self.disable.grid(row = 1, column = 2)

        self.delete=tk.Button(self,text="  Delete All Logs ",
                                 font=("helvetica", 10),command=self.delete_log,
                                 bg="black",fg="white",bd=0,
                                 highlightbackground="black",compound="top",
                                 activebackground="black",
                                 activeforeground="white",image=icons[49])
        self.delete.grid(row = 2, column = 0, columnspan = 3)
        ...
        tk.Button(self,text="Go Home",image=icons[16],anchor="center",bd=0,
                  ...
                  command=lambda:controller.show_frame("HomeFrame")).grid(row=3,
                                                                          column=2)
        self.status = tk.Label(self,text="Logs Enabled", bg="spring green", fg="black" )
        self.status.place(x=75, y=150)
...
class ShutdownFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.warningLabel=tk.Label(self,bg="black",fg="Deep sky blue",
                                   font=("helvetica", 15),text = "Selecting this "\
                                   "shuts down \nyour GSM Module and UI")
        self.warningLabel.grid(row = 0, column = 0, columnspan = 3)
        tk.Label(self,text="Press OK to confirm",fg="yellow",bg="black",
                 font=("helvetica", 12)).grid(row=1,column=1,sticky="nsew")
        
        ok=tk.Button(self,text="OK",fg="yellow",image=icons[44],anchor="center",
                     font=("helvetica",10),highlightbackground="white",
                     bg="black",activebackground="black",activeforeground="white",
...
class LocationFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.getposition=tk.Button(self,text="  Get Position ",
                                   font=("helvetica",12),command=self.get_position,
                                   bg="black",fg="white",image=icons[14],bd=2,
        ...
        tk.Button(self,text="Go Home",image=icons[16],anchor="center",bd=0,
                  highlightbackground="black",bg="black",activebackground="black",
                  command = self.gohome).grid(row = 4, column = 1)
...
class TemplateFrame(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self,bg="black",fg="Deep sky blue",font=("Helvetica",14),
                 text="Develop\nyour apps here").grid(row=0,column=0,
                                                      columnspan = 2)
        ...
        tk.Button(self,text="Go Home",image=icons[16],anchor="center",bd = 0,
                  highlightbackground="black",bg="black",activebackground="black",
                  command=lambda:
                  self.controller.show_frame("Menu2Frame")).grid(row=1,column=1)
